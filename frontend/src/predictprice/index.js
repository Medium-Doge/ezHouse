...
const PredictPrice = () => {
  ...
  var backendData = {longitude: 1.3435001655425816, latitude: 103.70334820770225};
  ...
  useEffect(() => {
    ...
    axios({method: 'get', 
        ...
        setData(backendData);
        var positionVal = [parseFloat(data.latitude), parseFloat(data.longitude)]
  ...
  return (
    ...
    <MapContainer zoom={2}
                    ...
                    center={[1.3521, 103.8198]}>
                      <ChangeView center={position} zoom={2}></ChangeView>
                    <TileLayer
